...
const LegalLayout: React.FC<{
  title: string
  updated: string
  /** Show the "template — not yet legal advice" notice. Defaults to true; set
   * false once this specific document has actually been reviewed and approved. */
  reviewed?: boolean
  children: React.ReactNode
}> = ({ title, updated, reviewed = false, children }) => (
