...
const ArtistProfile: React.FC = () => {
  ...
  const artistQuery = useQuery(['artist-profile', id], () => artistsApi.getArtistProfile(id as string), {
    enabled: Boolean(id),
  })

  const modelsQuery = useQuery(
    ['artist-models', id, sortBy, page],
    () => artistsApi.getArtistModels(id as string, { sort: sortBy, page, limit: 12 }),
    {
      enabled: Boolean(id),
