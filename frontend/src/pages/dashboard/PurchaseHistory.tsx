...
const PurchaseHistory: React.FC = () => {
  return (
    <div className="px-4 py-10">
      ...
      <p className="text-gray-600 mt-2">Your past orders will show here.</p>
    </div>
  )
}
...
const PurchaseHistory: React.FC = () => {
  ...
  const ordersQuery = useQuery(['my-orders', { page: pageParam, limit: 10 }], () => ordersApi.getMyOrders(pageParam, 10), {
